...
//
// This lives in a module that prisma.ts and auth.ts import, rather than a Nitro
// plugin, because prisma.ts reads DATABASE_URL at module load — earlier than any
